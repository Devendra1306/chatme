...
import { RiRobot2Line, RiMailLine, RiLockPasswordLine, RiUserLine, RiEyeLine, RiEyeOffLine } from 'react-icons/ri'
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#1e3a5f] via-[#1e3a5f] to-slate-800 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <p className="text-slate-500 text-sm mb-6">Join ChatMe to get started</p>
